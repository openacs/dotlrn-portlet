...
<if @enrollment_policy_p@ eq 1 or @dotlrn_admin_p@ eq 1 >
      <li>
        #dotlrn-portlet.lt_Change_Enrollment_Pol# -
          <if @join_policy@ eq "open"><b>#dotlrn-portlet.Open#</b></if><else><a href="join-policy-toggle?policy=open" title="#dotlrn-portlet.set_policy_open#">#dotlrn-portlet.Open#</a></else>
        | <if @join_policy@ eq "closed"><b>#dotlrn-portlet.Closed#</b></if><else><a href="join-policy-toggle?policy=closed" title="#dotlrn-portlet.set_policy_closed#">#dotlrn-portlet.Closed#</a></else>
